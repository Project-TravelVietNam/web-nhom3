            ...
            <div className="flex flex-col items-center justify-center h-screen">
                <div className="w-full max-w-md bg-white bg-opacity-50 rounded-xl shadow-md py-10 px-10">
                    ...
                    <form className="flex flex-col" onSubmit={handleClick} disabled={loading}>
                        ...
                        {/* Nút gửi */}
                        <button className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-medium py-2 px-4 rounded-md hover:bg-indigo-600 hover:to-blue-600 transition ease-in duration-200" type="submit">
                            Đăng nhập
                        </button>
                        ...
                        <p className="text-black mt-4 text-center">
                            ...
                            <a href="/signup" className="text-blue-500 font-bold hover:underline mt-4 px-1">Đăng ký</a>
                        </p>
                        <div className="mt-4 text-center">
                            <a href="/forgotpass" className="text-blue-500 font-bold hover:underline">Quên mật khẩu?</a>
                        </div>
                    </form>
                </div>
            </div>
